...
class hexapodserviceAction(genpy.Message):
  _md5sum = "004abf930406a06c885a35bef9a175af"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2i4d.pack(_x.action_goal.goal.MODE, _x.action_goal.goal.SIMPLEMOTION_MODE, _x.action_goal.goal.ONELEG.coxa, _x.action_goal.goal.ONELEG.femur, _x.action_goal.goal.ONELEG.tibia, _x.action_goal.goal.ONELEG.tarsus))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_4d.pack(*self.action_result.result.position_fdbk))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.status, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.fdb))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.MODE, _x.action_goal.goal.SIMPLEMOTION_MODE, _x.action_goal.goal.ONELEG.coxa, _x.action_goal.goal.ONELEG.femur, _x.action_goal.goal.ONELEG.tibia, _x.action_goal.goal.ONELEG.tarsus,) = _struct_2i4d.unpack(str[start:end])
      ...
      self.action_result.result.position_fdbk = _struct_4d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.status, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.fdb,) = _struct_i.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(self.action_result.result.position_fdbk.tostring())
      _x = self.action_result.result.result
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_result.result.position_fdbk = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=4)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
